...
//acıları double degisken durunde, angle1,angle2,angle3 degiskenlerine set eden method
...
//donusum degiskenlerini transx,transy,transz olarak set eden method(x-y-z her noktanın uc boyutlu degisim degeridir)
